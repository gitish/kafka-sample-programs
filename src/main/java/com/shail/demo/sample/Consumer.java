...
/**
 * This program reads messages from two topics. Messages on "shailTest" are analyzed to estimate
 * latency (assuming clock synchronization between producer and consumer).
 * <p/>
                        ...
                        try {
                            ...
                            switch (msg.get("type").asText()) {
                                ...
                                case "marker":
                                    ...
                                    System.out.printf("%d messages received in period, latency(min, max, avg, 99%%) = %d, %d, %.1f, %d (ms)\n", stats.getTotalCount(), stats.getValueAtPercentile(0), stats.getValueAtPercentile(100), stats.getMean(), stats.getValueAtPercentile(99));
                                    System.out.printf("%d messages received overall, latency(min, max, avg, 99%%) = %d, %d, %.1f, %d (ms)\n", global.getTotalCount(), global.getValueAtPercentile(0), global.getValueAtPercentile(100), global.getMean(), global.getValueAtPercentile(99));
